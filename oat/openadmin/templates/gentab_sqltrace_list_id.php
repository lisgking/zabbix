...
";
    ...
    function sysgentab_row_output($data)
    {
        ...
        foreach ($data as $index => $val)
        {
            ...
            if ( strcasecmp($index,"id")==0 )
            {
                $HTML.=<<<END
       <td>
       <form method="get" action="index.php">
       <span title="{$this->idsadmin->lang('ClickForSQLDetails')}">
       <input type=submit class=button name="view" value="{$this->idsadmin->lang('DrillDown')}" ></span>
