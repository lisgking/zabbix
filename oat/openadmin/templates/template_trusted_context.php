...
class template_trusted_context {
    ...
    function render_trusted_context($lang="en_US")
    {
		$height = 685;
        ...
        $resourceModuleURLS = "swfs/trustedContext/trustedContext_en_US.swf,swfs/lib/oat_en_US.swf,swfs/lib/rdfwidgets_en_US.swf";
        if ($lang == "en_US")
        {
    	    $localeChain = "en_US";
        } else {
    	    $localeChain = "{$lang},en_US";
    	    $resourceModuleURLS .= ",swfs/trustedContext/trustedContext_{$lang}.swf,swfs/lib/oat_{$lang}.swf,swfs/lib/rdfwidgets_{$lang}.swf";
        }
		...
		<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"
        	...
        	<param name="movie" value="swfs/trustedContext/trustedContext.swf" />
        	...
        	<embed src="swfs/trustedContext/trustedContext.swf" 
