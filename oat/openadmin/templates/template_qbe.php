...
class template_qbe {
    ...
    function renderQBE($lang="en_US")
    {
    	...
    	$resourceModuleURLS = "swfs/qbe/qbe_en_US.swf,swfs/lib/oat_en_US.swf";
        if ($lang == "en_US")
    	{
    	    $localeChain = "en_US";
    	} else {
    	    $localeChain = "{$lang},en_US";
    	    $resourceModuleURLS .= ",swfs/qbe/qbe_{$lang}.swf,swfs/lib/oat_{$lang}.swf";  
    	}
		...
		<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"
        	...
        	<param name="movie" value="swfs/qbe/qbe.swf" />
