...
class template_privileges {
    ...
    function render_non_os_users($user_authorized=true, $lang="en_US")
    {
		...
		$flashvars = "servername={$this->idsadmin->phpsession->instance->get_servername()}"
			...
			. "&userAuthorized=" . (($user_authorized)? "true":"false")
			...
			. "&pamPorts={$this->pamPorts}";

		$resourceModuleURLS = "swfs/privileges/privileges_en_US.swf,swfs/lib/oat_en_US.swf,swfs/lib/rdfwidgets_en_US.swf";
		if ($lang == "en_US")
		{
			$localeChain = "en_US";
		} else {
			$localeChain = "{$lang},en_US";
			$resourceModuleURLS .= ",swfs/privileges/privileges_{$lang}.swf,swfs/lib/oat_{$lang}.swf,swfs/lib/rdfwidgets_{$lang}.swf";
		}
		...
		<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"
        	...
        	<param name="movie" value="swfs/privileges/privileges.swf" />
        	...
        	<embed src="swfs/privileges/privileges.swf"
...
return $HTML;
    ...
    function render_admin_privileges($user_authorized=true, $lang="en_US")
    {
		...
		$flashvars = "serverVersion={$this->idsadmin->phpsession->serverInfo->getVersion()}"
				   ...
				   . "&gridList=" . implode(",",$this->idsadmin->phpsession->serverInfo->getGridsForServer($this->idsadmin));
		...
		<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"
				...
				height="685"
				codebase="http://fpdownload.macromedia.com/get/flashplayer/current/swflash.cab">
        	<param name="movie" value="swfs/privileges/privileges_admin.swf" />
        	<param name="quality" value="high" />
        	<param name="bgcolor" value="#869ca7" />
        	<param name="allowScriptAccess" value="sameDomain" />
        	<param name="wmode" value="transparent" />
        	...
        	<embed src="swfs/privileges/privileges_admin.swf"
    	    	quality="high" bgcolor="#869ca7"
				width="100%"
       		 	height="685"
        		name="ca"
