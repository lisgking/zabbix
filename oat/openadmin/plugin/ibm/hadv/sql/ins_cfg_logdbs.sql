...
-- Red Alarm - Left check value 
         "select count(*)  from sysmaster:syschunks t1, sysmaster:syslogfil t2 where t1.chknum=t2.chunk and t1.dbsnum=1", 
...
-- Yellow Alarm - Left check value 
         "select count(*) from sysmaster:syschunks t1, sysmaster:syslogfil t2, sysmaster:systabnames t3 where t1.chknum=t2.chunk and t1.dbsnum > 1 and t3.partnum > (t1.dbsnum*1048576)+1 and t3.partnum < ((t1.dbsnum+1)*1048576)+1", 
