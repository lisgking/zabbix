...
-- Red Alarm - Left check value 
         "select ( (t1.value  /  t2.value) / (t3.pl_bufsize) ) *  100 from sysmaster:sysprofile t1, sysmaster:sysprofile t2, sysmaster:sysplog t3 where t1.name='plgpagewrites' and t2.name='plgwrites' ", 
